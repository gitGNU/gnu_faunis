...
public class RoughMovingTask extends MovingTask<ServerPlayer, MapManager> {

	public RoughMovingTask(Mover<ServerPlayer, MapManager> parent, ServerPlayer moveable) {
