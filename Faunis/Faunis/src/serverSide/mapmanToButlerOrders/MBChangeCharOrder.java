...
public class MBChangeCharOrder extends MBOrder {
	...
	private final PlayerData graphStatus;

	public MBChangeCharOrder(MapManager source, String playerName, PlayerData graphStatus) {
		super(source);
	...
	public PlayerData getGraphStatus() {
		return graphStatus;
	}
}
