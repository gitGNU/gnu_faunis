...
public interface AccountsArchivist {
	...
	/** locks allExistingPlayerNames, account <br />
	...
	boolean savePlayer(ServerPlayer player);
	 ...
	 */
	Result<ServerPlayer> loadAndActivatePlayer(Account account, String playerName);
}
